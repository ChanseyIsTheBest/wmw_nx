...
// Serialises newlib's fd-table-mutating entry points; see libc_shim.c for why
// this is mandatory rather than defensive. Recursive. Any shim that opens,
// closes, or resolves a path to a device must hold it.
...
// The engine additionally pulls these stdio entry points; they operate on the
// genuine newlib FILE* returned by fopen_fake, guarding the 3 fake std streams.
